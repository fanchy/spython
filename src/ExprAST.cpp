...
PyObjPtr& DumpAST::eval(PyContext& context){
    PyObjPtr val = testlist1->eval(context);
    string s = val->getHandler()->handleStr(context, val);
    return context.cacheResult(PyCppUtil::genStr(s));
}
